...
export const TEST_POOL: LiquidityPoolInfo = {
    name: 'test_pool',
    coin: { ...TEST1 },
    pc: { ...TEST2 },
    lp: { ...TEST_LPTOKEN['TEST'] },
    ...
    ammQuantities: '6TzAjFPVZVMjbET8vUSk35J9U2dEWFCrnbHogsejRE5h', // Dummy
    ...
    serumBids: "ANHHchetdZVZBuwKWgz8RSfVgCDsRpW9i2BNWrmG9Jh",
